...
- **Real-time / I/O:** snickerdoodle black (deterministic I/O, wheel control plumbing)
...
- **Sensors:**
  - OAK‑D Lite (stereo depth + RGB)
  - RPLIDAR A1 (2D LiDAR for mapping/localization/obstacle avoidance)
- **Manipulator:** RoArm‑M2‑S
...
- Closed-loop velocity control on snickerdoodle
